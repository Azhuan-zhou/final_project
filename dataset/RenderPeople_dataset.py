...
class RenderPeopleDatasetBatch(Dataset):
    def __init__(self, data_root, split='test', multi_person=True, num_instance=450, poses_start=0, poses_interval=2, poses_num=10, image_scaling=1.0, white_back=False, sample_obs_view=True, fix_obs_view=False):
